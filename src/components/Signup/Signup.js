...
const Signup = (props) => {
    ...
    const registerCall = () => {
        if (!isEmptyField(firstName)) {
            ...
            alert.error('Please enter Last Name!');
        }  else if (!isEmptyField(workUrl)) {
            alert.error('Please enter work URL!');
    ...
    return (
        <Container>
            ...
            <RadioContainer>
                ...
                <RadioButton type="radio" value={"designer"} checked={role == "designer"} onChange={handleChnageRole}/>Designer
                <RadioButton type="radio" value={"developer"} checked={role == "developer"} onChange={handleChnageRole}/>Developer
                <RadioButton type="radio" value={"other"} checked={role == "other"} onChange={handleChnageRole}/>Other
            </RadioContainer>

            <WorkUrlContainer>
                <WorkUrlContainerLeft>
                    <TextField value={workUrl} onChange={handleWorkUrl} placeholder={""} heading={"WORKSPACE URL"} />
                </WorkUrlContainerLeft>
                <WorkUrlContainerRight>
                    <WorkUrlContainerTest>{workSpaceEndpoint}</WorkUrlContainerTest>
                </WorkUrlContainerRight>
            </WorkUrlContainer>
            ...
            <ButtonsContainer>
                <PrimaryButton onClick={registerCall}>Create Workspace</PrimaryButton>
                <SecondaryButton onClick={handleSignin}>Login to Workspace</SecondaryButton>
            </ButtonsContainer>
        </Container>
    )
}
